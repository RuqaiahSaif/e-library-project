...
<div class="card mb-4">
  <h5 class="card-header">اضافة طلب</h5>
  <form class="card-body" action="/save_offers" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">حالة الطلب</label>
        <input name="status" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الاجمالي</label>
        <input name="total" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الخصم</label>
        <input name="discount" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
       <div class="col-md-6">
        <label class="form-label" for="multicol-username">طريقة الدفع</label>
        <input name="payment_method" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">العنوان</label>
                <input name="address" type="number" id="multicol-username" class="form-control" placeholder="" />
        </div>
