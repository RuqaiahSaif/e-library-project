...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item active open">
     ...
     <li class="menu-item active open">
      <a href="javascript:void(2);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Form Layouts">catogries</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="/new_user" class="menu-link">
        ...
        <li class="menu-item">
          <a href="form-layouts-horizontal.html" class="menu-link">
            <div data-i18n="Horizontal Form">edit Category</div>
          </a>
        </li>
     ...
     <li class="menu-item active open">
      <a href="javascript:void(3);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="users">users</div>
      </a>
      <ul class="menu-sub">
         <li class="menu-item">
          <a href="form-layouts-horizontal.html" class="menu-link">
            <div data-i18n="add user">user</div>
          </a>
        </li>
        <li class="menu-item active">
          <a href="/new_user" class="menu-link">
