...
<div class="card mb-4">
  <h5 class="card-header">اضافةعنوان مستخدم</h5>
  <form class="card-body" action="/save_useraddress" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">المدينة</label>
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">تفعيل </label>
