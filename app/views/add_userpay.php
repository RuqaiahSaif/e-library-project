...
<div class="card mb-4">
  <h5 class="card-header">'اضافة طريقة دفع</h5>
  <form class="card-body" action="/save_userpays" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الدفع</label>
        <input name="payment" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
